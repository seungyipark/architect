...
이 <b>효율적인 가변객체*를 다른 스레드로 전달하는 것을</b>안전출판*이라 한다.<br>
<br>
...
<table><thead><th><b><b>활동실패</b>, <i>안전실패*가 생기지 않도록 하려면,</i></b></th></thead><tbody>
<tr><td> </td></tr>
...
<tr><td><b>조건적 스레드 안전*의 락이 필요한 경우와 어떤 락이 필요한지 기술해야한다.</b></td></tr>
